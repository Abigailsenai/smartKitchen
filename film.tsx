...
export function Film() {
  ...
  async function gerarReceita() {
    ...
    const prompt = `Me faça uma indicação de ${ocasiao} se baseando nessas informações: Meus gêneros favoritos são: ${ingr1}, ${ingr2}, gosto de filmes estrelados por ${ingr3} e gosto de produções de ${ingr4}`;
  ...
  return (
    <View style={ESTILOS.container}>
      ...
      <Text style={ESTILOS.header}>Bom entretenimento</Text>
      <View style={ESTILOS.form}>
        ...
        />
        <TextInput
          placeholder="Atriz/ ator favorito"
          style={ESTILOS.input}
          value={ingr3}
      ...
      <TouchableOpacity style={ESTILOS.button} onPress={gerarReceita}>
        ...
        <MaterialCommunityIcons name="filmstrip" size={24} color="#FFF" />
      </TouchableOpacity>

      <ScrollView contentContainerStyle={{ paddingBottom: 24, marginTop: 4, }} style={ESTILOS.containerScroll} showsVerticalScrollIndicator={false} >
        {load && (
          <View style={ESTILOS.content}>
            <Text style={ESTILOS.title}>Encontrando o melhor {ocasiao}...</Text>
        ...
        {receita && (
          <View style={ESTILOS.content}>
            <Text style={ESTILOS.title}>Indicação de {ocasiao} 👇</Text>
