...
export function Msc() {
  ...
  async function gerarReceita() {
    ...
    const prompt = `Me faça uma indicação de música se baseando nessas informações: Meus gêneros favoritos são: ${ingr1}, ${ingr2}, gosto das músicas de ${ingr3} e gosto de músicas de ${ingr4}`;
  ...
  return (
    <View style={ESTILOS.container}>
      ...
      <Text style={ESTILOS.header}>Músicas certas</Text>
      <View style={ESTILOS.form}>
        ...
        />
        <TextInput
          placeholder="Cantor (a) favorito (a)"
          style={ESTILOS.input}
          value={ingr3}
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 24, marginTop: 4, marginBottom: 4000}} style={ESTILOS.containerScroll} showsVerticalScrollIndicator={false} >
        {load && (
          <View style={ESTILOS.content}>
            <Text style={ESTILOS.title}>Encontrando a melhor música...</Text>
        ...
        {receita && (
          <View style={ESTILOS.content}>
            <Text style={ESTILOS.title}>Indicação de música 👇</Text>
